            ...
            @section('javascript')
                <script src="{{ asset('js/mypage/edit.css') }}" defer></script>
            @endsection
            ...
            <form class="card profile" action="/mypage/update" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body overflow-hidden">
                    ...
                    <div class='row mb-3'>
                        <div class='col-md-12 col-lg-5'>
                            <img class="profile__image" src="{{ empty($user->image) ? '/images/user-icon.png' : $user->image }}" >
                        </div>
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" name="user[name]" class="form-control profile__name" placeholder="ユーザー名" aria-label="ユーザー名" aria-describedby="basic-addon1" value="{{ $user->name }}">
                    </div>
                ...
                <button class='btn btn-lg btn-secondary d-block m-auto'>削除</button>
            @endsection
